...
facet/
├── bin/
│   ├── facet.cr              # Main CLI entry point
│   └── facet_compile.cr      # Original template→Crystal compiler
├── src/
│   └── facet/
│       ├── compiler.cr       # Crystal code generator
│       ├── parser.cr         # HCR parser
│       ├── static_compiler.cr # HTML/CSS/JS compiler (new)
│       └── ...
├── test/
│   ├── dashboard.hcr
│   └── login.hcr
